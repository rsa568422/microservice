...
import static com.example.microservice.task.configuration.Constants.HIBERNATE_DIALECT;
import static com.example.microservice.task.configuration.Constants.HIBERNATE_HBM_2_DDL_AUTO;
import static com.example.microservice.task.configuration.Constants.JPA;
import static com.example.microservice.task.configuration.Constants.JPA_DATASOURCE;
import static com.example.microservice.task.configuration.Constants.JPA_DATASOURCE_PROPERTIES;
import static com.example.microservice.task.configuration.Constants.JPA_ENTITY_MANAGER_FACTORY;
import static com.example.microservice.task.configuration.Constants.JPA_ENTITY_PACKAGE;
import static com.example.microservice.task.configuration.Constants.JPA_REPOSITORY_PACKAGE;
import static com.example.microservice.task.configuration.Constants.JPA_TRANSACTION_MANAGER;
import static com.example.microservice.task.configuration.Constants.POSTGRES_SQL_DIALECT;
import static com.example.microservice.task.configuration.Constants.UPDATE;
